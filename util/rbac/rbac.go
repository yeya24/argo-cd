...
func (e *Enforcer) SetMatchMode(mode string) {
	...
	e.AddFunction("globOrRegexMatch", func(args ...interface{}) (interface{}, error) {
		if mode == RegexMatchMode {
...
func (e *Enforcer) GetGroupingPolicy() [][]string {
	return e.wrapperEnforcer.GetGroupingPolicy()
}

func (e *Enforcer) AddFunction(name string, function func(args ...interface{}) (interface{}, error)) {
	e.wrapperEnforcer.AddFunction(name, function)
